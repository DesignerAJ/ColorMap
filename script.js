...
map.on('load', function () {
    ...
    map.addLayer(
        {
            id: 'country-fill', // 레이어 ID를 더 명확하게 변경
            source: 'country-boundaries', // 위에서 정의한 소스 ID 사용
        ...
        'country-label' // 'country-label' 레이어 아래에 추가하여 레이블이 가려지지 않도록 함
    );
